...
class JinjaCommand(CLICommand):
    ...
    def register(self, subparsers: Any):
        ...
        self.parser.add_argument(
            "-m", "--model",
            default="rst",
            help=f"Which model to use. Can be one of {self.MODELS} or a path to a model directory."
        )
        self.parser.add_argument(
            "-T", "--templates",
        ...
        self.parser.set_defaults(func=self.jinja)
